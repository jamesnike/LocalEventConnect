...
export default function Home() {
  ...
  const handleUndo = () => {
    ...
    if (lastSwipedEvent) {
      setSwipedEvents((prev: Set<number>) => {
      ...
      <div className="bg-white border-t border-gray-200 px-4 py-4 pb-20">
        <div className="flex justify-center space-x-8">
          <button
            ...
            className="w-14 h-14 bg-red-500 text-white rounded-full flex items-center justify-center shadow-lg hover:bg-red-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
            <X className="w-6 h-6" />
          </button>
          ...
          <button
            ...
            className="w-12 h-12 bg-gray-400 text-white rounded-full flex items-center justify-center shadow-lg hover:bg-gray-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
          ...
          <button
            ...
            disabled={!currentEvent}
            className="w-14 h-14 bg-green-500 text-white rounded-full flex items-center justify-center shadow-lg hover:bg-green-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
