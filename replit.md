...
- July 11, 2025. ENHANCED MEMBER AVATAR DISPLAY: Updated EventDetail component to show up to 10 member avatars (increased from 5) using small dots (size="xs") instead of medium avatars. Adjusted spacing to -space-x-1 for compact display and updated overflow indicator to show "+X more" when there are more than 10 members.
